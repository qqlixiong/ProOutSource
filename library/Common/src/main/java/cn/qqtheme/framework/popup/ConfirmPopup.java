...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0XFFE8EEEE;
    protected int topLineHeightPixels = 1;//px
    protected int topBackgroundColor = 0XFFE8EEEE;
    ...
    protected int cancelTextColor = 0xFFC41f28;
    protected int submitTextColor = 0xFFC41f28;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0XFFC41f28;
