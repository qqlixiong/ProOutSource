...
public class WheelView extends View {
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF000000;    //选中文本的颜色
    public static final int TEXT_COLOR_NORMAL = 0XFFBBBBBB;   //未选中文本的颜色
    public static final int DIVIDER_COLOR = 0XFFE6E5E5;       //线的颜色
