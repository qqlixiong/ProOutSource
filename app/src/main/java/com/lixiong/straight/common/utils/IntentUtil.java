...
public class IntentUtil {
    ...
    public static void startActivity2(@NonNull Context currentContext, Class<? extends Activity> targetClass) {
        startActivity2(currentContext, targetClass, null);
    }

    public static void startActivity2(@NonNull Context currentContext, Class<? extends Activity> targetClass, Bundle
            extras) {
