...
public class UIUtils {
     ...
     * @param id          下划线颜色的ID
     */
    public static void setUnderline(TextView textView,int id){
    ...
    public static View inflate(int viewId,ViewGroup root){
        return LayoutInflater.from(getContext()).inflate(viewId,root);
    }

    public static View inflate(int viewId,ViewGroup root, boolean attachToRoot){
        return LayoutInflater.from(getContext()).inflate(viewId,root,attachToRoot);
    }
     ...
     * @param textViews
     */
    public static void setFakeBoldText(TextView... textViews){
    ...
    public static void toast(int id, boolean isLengthLong){
        Toast.makeText(UIUtils.getContext(), getString(id),isLengthLong? Toast.LENGTH_LONG : Toast.LENGTH_SHORT).show();
    }
